...
--
-- Host: 127.0.0.1
-- Generation Time: 18-Abr-2020 às 22:42
...
--
-- Estrutura da tabela `tab_estado`
--
...
--
-- Extraindo dados da tabela `tab_estado`
--

INSERT INTO `tab_estado` (`cod_estado`, `sigla`, `nome`) VALUES
(11, 'RO', 'Rondônia'),
(12, 'AC', 'Acre'),
(13, 'AM', 'Amazonas'),
(14, 'RR', 'Roraima'),
...
--
-- Estrutura da tabela `tab_municipio`
--
...
--
-- Extraindo dados da tabela `tab_municipio`
--

INSERT INTO `tab_municipio` (`cod_municipio`, `nome`, `cod_estado`) VALUES
...
--
-- Estrutura da tabela `tb_amostra`
--

CREATE TABLE `tb_amostra` (
  `idAmostra` int(10) UNSIGNED NOT NULL,
  `idCodGAL_fk` int(10) UNSIGNED DEFAULT NULL,
  `idNivelPrioridade_fk` int(10) UNSIGNED NOT NULL,
...
(19, NULL, 1, 0, 43, NULL, '', '2020-04-03', 'g', 3, NULL, '', '', 'L19', '', '', '', 'nao quero'),
(20, NULL, 1, 0, 43, NULL, 'anotações extra', '2020-04-03', 'g', 3, NULL, '', '', 'L20', '', '', '', 'nao quero'),
(23, NULL, 1, 0, 43, NULL, '', '2020-04-14', 'a', 3, NULL, '', '', 'L23', '', '', '', ''),
(24, NULL, 1, 0, 43, NULL, '', '2020-04-14', 'a', 3, NULL, '', '', 'L24', '', '', '', ''),
(25, NULL, 1, 0, 43, NULL, '', '2020-04-14', 'a', 3, NULL, '', '', 'L25', '', '', '', ''),
(26, NULL, 1, 0, 43, NULL, '', '2020-04-14', 'a', 3, NULL, '', '', 'L26', '', '', '', ''),
(27, NULL, 1, 0, 43, NULL, '', '2020-04-14', 'a', 3, NULL, '', '', 'L27', '', '', '', ''),
(28, NULL, 1, 0, 43, NULL, '', '2020-04-14', 'a', 3, NULL, '', '', 'L28', '', '', '', ''),
(29, NULL, 1, 0, 43, NULL, '', '2020-04-14', 'a', 3, NULL, '', '', 'L29', '', '', '', ''),
(57, NULL, 1, 0, 43, NULL, '', '2020-04-06', 'a', 4, NULL, '', '', 'E57', '', '', '', ''),
(58, NULL, 1, 0, 43, NULL, '', '2020-04-15', 'g', 3, NULL, '', '', 'L58', '', '', '', ''),
(60, NULL, 1, 0, 43, NULL, '', '2020-04-15', 'r', 3, NULL, '', '', 'L60', '', '', '', ''),
(61, NULL, 1, 0, 43, NULL, '', '2020-04-09', 'r', 3, NULL, '', '', 'L61', '', '', '', '');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_cadastroamostra`
--

CREATE TABLE `tb_cadastroamostra` (
  `idCadastroAmostra` int(11) NOT NULL,
  `idAmostra_fk` int(10) UNSIGNED NOT NULL,
  `idLocalArmazenamento_fk` int(10) UNSIGNED DEFAULT NULL,
...
--
-- Extraindo dados da tabela `tb_cadastroamostra`
--
...
(1, 12, NULL, 2, '2020-04-14 20:51:37', '2020-04-14 20:55:34'),
(2, 13, NULL, 5, '2020-04-14 21:02:43', '2020-04-14 21:03:12');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_capela`
--

CREATE TABLE `tb_capela` (
  `idCapela` int(10) UNSIGNED NOT NULL,
  `numero` int(10) UNSIGNED NOT NULL,
  `statusCapela` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_capela`
--

INSERT INTO `tb_capela` (`idCapela`, `numero`, `statusCapela`) VALUES
(1, 1, 'OCUPADA'),
(2, 2, 'LIBERADA'),
(4, 3, 'OCUPADA'),
(5, 4, 'LIBERADA');
...
--
-- Estrutura da tabela `tb_codgal`
--

CREATE TABLE `tb_codgal` (
  `idCodGAL` int(10) UNSIGNED NOT NULL,
  `idPaciente_fk` int(10) UNSIGNED NOT NULL,
  `codigo` bigint(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_codgal`
--
...
--
-- Estrutura da tabela `tb_dataimpressao`
--

CREATE TABLE `tb_dataimpressao` (
  `idDataImpressao` int(10) UNSIGNED NOT NULL,
...
--
-- Estrutura da tabela `tb_detentor`
--

CREATE TABLE `tb_detentor` (
  `idDetentor` int(11) NOT NULL,
  `detentor` varchar(100) DEFAULT NULL,
  `index_detentor` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_detentor`
--

INSERT INTO `tb_detentor` (`idDetentor`, `detentor`, `index_detentor`) VALUES
(11, 'empresa a', 'EMPRESA A'),
(12, 'empresa 123', 'EMPRESA 123'),
(13, 'empresa 12', 'EMPRESA 12'),
(14, 'empresa aaaa', 'EMPRESA AAAA'),
(15, 'empresa aaaa90', 'EMPRESA AAAA90'),
(16, 'empra tt', 'EMPRA TT'),
(17, 'empresa americ', 'EMPRESA AMERIC'),
(18, 'empresa aaaa9090', 'EMPRESA AAAA9090'),
(20, 'empresa a', 'EMPRESA A');
...
INSERT INTO `tb_doenca` (`idDoenca`, `doenca`, `index_doenca`) VALUES
(6, 'covid19', 'COVID19'),
(7, 'H1N1', 'H1N1'),
(8, 'gripe suína', 'GRIPE SUINA'),
(9, 'doenca 1', 'DOENCA 1'),
(10, 'doenca 2', 'DOENCA 2'),
(11, 'doença 3', 'DOENçA 3'),
(12, 'doença 10', 'DOENçA 10'),
(13, 'doenca 23', 'DOENCA 23'),
(14, 'H1N89', 'H1N89'),
(15, 'hjhjhj', 'HJHJHJ');
...
CREATE TABLE `tb_equipamento` (
  ...
  `idDetentor_fk` int(11) NOT NULL,
  `idMarca_fk` int(11) DEFAULT NULL,
  `idModelo_fk` int(11) DEFAULT NULL,
  `dataUltimaCalibragem` date NOT NULL,
...
INSERT INTO `tb_equipamento` (`idEquipamento`, `idDetentor_fk`, `idMarca_fk`, `idModelo_fk`, `dataUltimaCalibragem`, `dataChegada`) VALUES
(9, 11, 13, 9, '2020-01-31', '2020-04-01'),
(10, 16, 14, 11, '2020-01-30', '2020-01-09'),
(11, 11, 8, 8, '2020-03-12', '2020-03-11'),
(12, 11, 8, 8, '2020-03-12', '2020-03-11'),
(13, 11, 8, 8, '2020-03-12', '2020-03-11'),
(14, 11, 8, 8, '2020-03-12', '2020-03-11'),
(15, 11, 8, 8, '2020-03-12', '2020-03-11'),
(16, 11, 8, 8, '2020-03-12', '2020-03-11'),
(17, 11, 8, 8, '2020-03-12', '2020-03-11'),
(18, 11, 10, 11, '2020-04-02', '2020-04-04');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_etiqueta`
--

CREATE TABLE `tb_etiqueta` (
  `idEtiqueta` int(10) UNSIGNED NOT NULL,
  `idUsuario_fk` int(10) UNSIGNED NOT NULL,
  `idDoenca_fk` int(10) UNSIGNED NOT NULL,
  `idAmostra_fk` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_etnia` (`idEtnia`, `etnia`, `index_etnia`) VALUES
(1, 'Branca', 'BRANCA'),
(2, 'Parda', 'PARDA'),
(3, 'Indígena', 'INDIGENA'),
(4, 'Preta', 'PRETA'),
(5, 'Amarela', 'AMARELA'),
(6, 'Sem declaração', 'SEM DECLARACAO');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_extracao`
--

CREATE TABLE `tb_extracao` (
  `idExtracao` int(10) UNSIGNED NOT NULL,
  `idUsuario_fk` int(10) UNSIGNED NOT NULL,
  `idAmostra_fk` int(10) UNSIGNED NOT NULL,
  ...
  `reteste` tinyint(1) NOT NULL,
  `dataHoraInicio` date NOT NULL,
  `dataHoraFim` date NOT NULL,
  `observacoes` varchar(300) DEFAULT NULL,
  `qnts_reteste` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_infostubo`
--

CREATE TABLE `tb_infostubo` (
  `idInfosTubo` int(10) UNSIGNED NOT NULL,
  `idUsuario_fk` int(10) UNSIGNED DEFAULT NULL,
  `idLocalArmazenamento_fk` int(10) UNSIGNED DEFAULT NULL,
  `idTubo_fk` int(10) UNSIGNED DEFAULT NULL,
  `statusTubo` varchar(100) NOT NULL,
  `etapa` varchar(100) NOT NULL,
  `dataHora` datetime NOT NULL,
  `reteste` char(1) DEFAULT NULL,
  `volume` double DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_infostubo`
--
...
--
-- Estrutura da tabela `tb_laudo`
--

CREATE TABLE `tb_laudo` (
  `idLaudo` int(10) UNSIGNED NOT NULL,
  `idAmostra_fk` int(10) UNSIGNED NOT NULL,
  `idUsuario_fk` int(10) UNSIGNED NOT NULL,
  `dataHoraLiberacao` datetime NOT NULL,
  `observacoes` varchar(300) DEFAULT NULL,
  `registro_SUS` tinyint(1) NOT NULL,
...
--
-- Estrutura da tabela `tb_localarmazenamento`
--

CREATE TABLE `tb_localarmazenamento` (
  `idLocalArmazenamento` int(10) UNSIGNED NOT NULL,
  `idTipoLocal_fk` int(10) UNSIGNED NOT NULL,
  `idTempoPermanencia_fk` int(11) NOT NULL,
...
--
-- Estrutura da tabela `tb_lugarorigem`
--

CREATE TABLE `tb_lugarorigem` (
  `idLugarOrigem` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `tb_marca` (`idMarca`, `marca`, `index_marca`) VALUES
(8, 'marca a', 'MARCA A'),
(9, 'marca b', 'MARCA B'),
(10, 'marca abc', 'MARCA ABC'),
(11, 'marca 123', 'MARCA 123'),
(12, 'marca aaaaaaaaaaaaaaa', 'MARCA AAAAAAAAAAAAAAA'),
(13, 'marca c', 'MARCA C'),
(14, 'MARCA 39', 'MARCA 39');
...
CREATE TABLE `tb_modelo` (
  ...
  `index_modelo` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_modelo` (`idModelo`, `modelo`, `index_modelo`) VALUES
(8, 'modelo a', 'MODELO A'),
(9, 'modelo aa', 'MODELO AA'),
(10, 'modelo ab', 'MODELO AB'),
(11, 'modelo b', 'MODELO B'),
(12, 'modelo 190', 'MODELO 190');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_nivelprioridade`
--

CREATE TABLE `tb_nivelprioridade` (
  `idNivelPrioridade` int(10) UNSIGNED NOT NULL,
  `nivel` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_nivelprioridade`
--

INSERT INTO `tb_nivelprioridade` (`idNivelPrioridade`, `nivel`) VALUES
(1, 2),
(2, 3),
(3, 6),
(4, 61),
...
(2, 6, 6, 'Ana', 'Mariana', '89723467893', '0000000000', '91760000', 'Avenida Coronel Marcos', NULL, 'Outro motivo', NULL, '', 'Desconhecido', '', 'NÃO SEI', 'Desconhecido', NULL, 'n'),
(21, 6, 2, 'nome5', '', '76777865776', '', '', '', '', 'Desconhecido', NULL, 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', NULL, 'n'),
...
(42, 6, 6, 'Ana', '', '33233222332', '', '', '', NULL, 'Desconhecido', NULL, 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', 'n'),
(43, 6, 6, 'Marcelo', '', '', '', '', '', NULL, 'Desconhecido', NULL, 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', 's'),
(71, 6, 6, 'Carine', '', '', '2121873265', '', '', NULL, 'Desconhecido', NULL, 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', 's'),
...
(73, 6, 6, 'paciente teste 3', '', '', '', '', '', NULL, 'Desconhecido', NULL, 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', 'Desconhecido', 'n'),
...
--
-- Estrutura da tabela `tb_perfilpaciente`
--

CREATE TABLE `tb_perfilpaciente` (
  `idPerfilPaciente` int(10) UNSIGNED NOT NULL,
...
--
-- Extraindo dados da tabela `tb_perfilpaciente`
--

INSERT INTO `tb_perfilpaciente` (`idPerfilPaciente`, `perfil`, `index_perfil`, `caractere`) VALUES
(1, 'Profissionais da Saúde', 'PROFISSIONAIS DA SAUDE', 'S'),
(2, 'Equipes de Voluntários', 'EQUIPES DE VOLUNTARIOS', 'V'),
(3, 'Pacientes SUS', 'PACIENTES SUS', 'L'),
(4, 'Funcionários ENGIE', 'FUNCIONARIOS ENGIE', 'E'),
(5, 'Outros', 'OUTROS', 'O');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_perfilusuario`
--

CREATE TABLE `tb_perfilusuario` (
  `idPerfilUsuario` int(10) UNSIGNED NOT NULL,
  `perfil` varchar(100) NOT NULL,
  `index_perfil` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_perfilusuario`
--

INSERT INTO `tb_perfilusuario` (`idPerfilUsuario`, `perfil`, `index_perfil`) VALUES
(1, 'Aluno', 'ALUNO'),
...
INSERT INTO `tb_recurso` (`idRecurso`, `nome`, `etapa`, `s_n_menu`) VALUES
(1, 'etapa_cadastrar_amostra', 'CADASTRO DE AMOSTRA', 's'),
(3, 'etapa_preparar_armazenar', 'PREPARO E ARMAZENAMENTO DE AMOSTRAS', 's'),
(5, 'etapa_extracao', 'EXTRAÇÃO DA AMOSTRAS', 's'),
(8, 'principal', 'PRINCIPAL', 's'),
(9, 'etapa_cadastro_amostra', 'ETAPA DO CADASTRO DA AMOSTRA', 's'),
(10, 'etapa_extracao_amostra', 'ETAPA DE EXTRAÇÃO DA AMOSTRA', 's'),
(11, 'cadastrar_sexoPaciente', 'CADASTRO DO SEXO DO PACIENTE', 's'),
(12, 'listar_sexoPaciente', 'LISTAR O SEXO DO PACIENTE', 's'),
(13, 'remover_sexoPaciente', 'REMOVER O SEXO DO PACIENTE', 's'),
(14, 'cadastrar_perfilPaciente', 'CADASTRO DO PERFIL DO PACIENTE', 's'),
(15, 'listar_perfilPaciente', 'LISTAR O PERFIL DO PACIENTE', 's'),
(16, 'remover_perfilPaciente', 'REMOVER O PERFIL DO PACIENTE', 's'),
(17, 'cadastrar_perfilUsuario', 'CADASTRAR O PERFIL DO USUÁRIO', 's'),
(18, 'listar_perfilUsuario', 'LISTAR O PERFIL DO USUÁRIO', 's'),
(19, 'remover_perfilUsuario', 'REMOVER O PERFIL DO USUÁRIO', 's'),
(20, 'cadastrar_doenca', 'CADASTRO DA DOENÇA', 's'),
(21, 'listar_doenca', 'LISTAR AS DOENÇAS', 's'),
(22, 'remover_doenca', 'REMOVER DOENÇA', 's'),
(23, 'editar_doenca', 'EDITAR DOENÇA', 's'),
(24, 'editar_perfilUsuario', 'EDITAR O PERFIL DO USUÁRIO', 's'),
(25, 'editar_perfilPaciente', 'EDITAR O PERFIL DO PACIENTE', 's'),
(26, 'editar_sexoPaciente', 'EDITAR O SEXO DO PACIENTE', 's'),
(27, 'cadastrar_nivelPrioridade', 'CADASTRAR O NÍVEL DE PRIORIDADE DA AMOSTRA', 's'),
(28, 'editar_nivelPrioridade', 'EDITAR O NÍVEL DE PRIORIDADE DA AMOSTRA', 's'),
(29, 'listar_nivelPrioridade', 'LISTAR O NÍVEIS DE PRIORIDADE DA AMOSTRA', 's'),
(30, 'remover_nivelPrioridade', 'REMOVER O NÍVEL DE PRIORIDADE DA AMOSTRA', 's'),
(31, 'cadastrar_usuario', 'CADASTRAR USUÁRIO', 's'),
(32, 'editar_usuario', 'EDITAR USUÁRIO', 's'),
(33, 'listar_usuario', 'LISTAR USUÁRIOS', 's'),
(34, 'remover_usuario', 'REMOVER USUÁRIO', 's'),
(35, 'cadastrar_recurso', 'CADASTRAR RECURSO', 's'),
(36, 'editar_recurso', 'EDITAR RECURSO', 's'),
(37, 'listar_recurso', 'LISTAR RECURSO', 's'),
(38, 'remover_recurso', 'REMOVER RECURSO', 's'),
(39, 'cadastrar_equipamento', 'CADASTRAR EQUIPAMENTO', 's'),
(40, 'editar_equipamento', 'EDITAR EQUIPAMENTO', 's'),
(41, 'listar_equipamento', 'LISTAR EQUIPAMENTOS', 's'),
(42, 'remover_equipamento', 'REMOVER EQUIPAMENTO', 's'),
(43, 'cadastrar_amostra', 'CADASTRAR AMOSTRA', 's'),
(44, 'listar_amostra', 'LISTAR AMOSTRA', 's'),
(45, 'remover_amostra', 'REMOVER AMOSTRA', 's'),
(46, 'cadastrar_detentor', 'CADASTRO DO DETENTOR', 's'),
(47, 'listar_detentor', 'LISTAR OS DETENTORES', 's'),
(48, 'remover_detentor', 'REMOVER DETENTOR', 's'),
(49, 'remover_marca', 'REMOVER MARCA', 's'),
(50, 'cadastrar_marca', 'CADASTRO DA MARCA', 's'),
(51, 'cadastrar_modelo', 'CADASTRO DO MODELO', 's'),
(52, 'listar_modelo', 'LISTAR OS MODELOS', 's'),
(53, 'remover_modelo', 'REMOVER MODELO', 's'),
(54, 'listar_marca', 'LISTAR MARCA', 's'),
(55, 'cadastrar_paciente', 'CADASTRO DE PACIENTE', 's'),
(56, 'listar_paciente', 'LISTAR OS PACIENTES', 's'),
(57, 'remover_paciente', 'REMOVER O PACIENTE', 's'),
(61, 'remover_rel_perfilUsuario_recurso', 'REMOVER RELACIONAMENTO ENTRE PERFIL DO USUÁRIO E OS RECURSOS', 's'),
(62, 'cadastrar_rel_perfilUsuario_recurso', 'CADASTRAR RELACIONAMENTO ENTRE PERFIL DO USUÁRIO E OS RECURSOS', 's'),
(63, 'listar_rel_perfilUsuario_recurso', 'LISTAR RELACIONAMENTO ENTRE PERFIL DO USUÁRIO E OS RECURSOS', 's'),
(64, 'cadastrar_usuario_perfilUsuario', 'CADASTRAR RELACIONAMENTO ENTRE O USUÁRIO E SEU PERFIL', 's'),
(65, 'remover_usuario_perfilUsuario', 'REMOVER RELACIONAMENTO ENTRE O USUÁRIO E SEU PERFIL', 's'),
(66, 'listar_usuario_perfilUsuario', 'LISTAR RELACIONAMENTO ENTRE O USUÁRIO E SEU PERFIL', 's'),
(67, 'cadastrar_capela', 'CADASTRAR CAPELA', 's'),
(68, 'listar_capela', 'LISTAR CAPELAS', 's'),
(69, 'remover_capela', 'REMOVER CAPELA', 's'),
(70, 'cadastrar_recurso', 'CADASTRO DE RECURSO', 's'),
(71, 'listar_recurso', 'LISTAR RECURSOS', 's'),
(72, 'remover_recurso', 'REMOVER  RECURSO', 's'),
(73, 'cadastrar_perfilUsuario', 'CADASTRO DE PERFIL DO USUÁRIO', 's'),
(74, 'remover_perfilUsuario', 'REMOVER PERFIL DO USUÁRIO', 's'),
(75, 'listar_perfilUsuario', 'LISTAR PERFIS DO USUÁRIO', 's'),
(76, 'editar_amostra', 'EDITAR AMOSTRA', 's'),
(77, 'editar_capela', 'EDITAR CAPELA', 's'),
(78, 'editar_detentor', 'EDITAR DETENTOR', 's'),
(79, 'editar_marca', 'EDITAR MARCA', 's'),
(80, 'editar_modelo', 'EDITAR MODELO', 's'),
(81, 'editar_rel_perfilUsuario_recurso', 'EDITAR RELACIONAMENTO ENTRE PERFIL DO USUÁRIO E OS RECURSOS', 's'),
(82, 'cadastrar_etnia', 'CADASTRAR ETNIA', 's'),
(83, 'editar_etnia', 'EDITAR ETNIA', 's'),
(84, 'remover_etnia', 'REMOVER ETNIA', 's'),
(85, 'listar_etnia', 'LISTAR ETNIAS', 's'),
(86, 'editar_paciente', 'EDITAR PACIENTE', 's'),
(87, 'editar_rel_perfilUsuario_recurso', 'EDITAR RELACIONAMENTO ENTRE PERFIL USUÁRIO E O RECURSO', 's'),
(88, 'cadastrar_tubo', 'CADASTRAR TUBO', 's'),
(89, 'editar_tubo', 'EDITAR TUBO', 's'),
(90, 'remover_tubo', 'REMOVER TUBO', 's');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_rel_amostra_tipo_local`
--

CREATE TABLE `tb_rel_amostra_tipo_local` (
  `idAmostraTipoLocal` int(10) UNSIGNED NOT NULL,
  `idLocalArmazenamento` int(10) UNSIGNED NOT NULL,
  `tb_amostra_idAmostra` int(10) UNSIGNED NOT NULL,
  `tb_tipoAmostra_idTipoAmostra` int(10) UNSIGNED NOT NULL,
  `qntTubos` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_rel_etiqueta_dataimpressao`
--

CREATE TABLE `tb_rel_etiqueta_dataimpressao` (
  `idEtiqueta_fk` int(10) UNSIGNED NOT NULL,
  `idDataImpressao_fk` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_rel_perfilusuario_recurso`
--

CREATE TABLE `tb_rel_perfilusuario_recurso` (
  `id_rel_perfilUsuario_recurso` int(10) UNSIGNED NOT NULL,
  `idPerfilUsuario_fk` int(10) UNSIGNED NOT NULL,
  `idRecurso_fk` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_rel_perfilusuario_recurso`
--

INSERT INTO `tb_rel_perfilusuario_recurso` (`id_rel_perfilUsuario_recurso`, `idPerfilUsuario_fk`, `idRecurso_fk`) VALUES
(41, 4, 1),
(42, 4, 3),
(43, 4, 5),
(44, 4, 8),
...
--
-- Estrutura da tabela `tb_rel_usuario_perfilusuario`
--

CREATE TABLE `tb_rel_usuario_perfilusuario` (
  `id_rel_usuario_perfilUsuario` int(10) UNSIGNED NOT NULL,
  `idPerfilUsuario_fk` int(10) UNSIGNED NOT NULL,
  `idUsuario_fk` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_rel_usuario_perfilusuario`
--

INSERT INTO `tb_rel_usuario_perfilusuario` (`id_rel_usuario_perfilUsuario`, `idPerfilUsuario_fk`, `idUsuario_fk`) VALUES
(20, 4, 2),
(21, 4, 4),
(22, 5, 5),
(23, 5, 6),
...
--
-- Estrutura da tabela `tb_rtpcr`
--

CREATE TABLE `tb_rtpcr` (
  `idRTPCR` int(10) UNSIGNED NOT NULL,
  `idUsuario_fk` int(10) UNSIGNED NOT NULL,
  `idAmostra_fk` int(10) UNSIGNED NOT NULL,
  `idEquipamento_fk` int(10) UNSIGNED NOT NULL,
  `cqGeneRdRP` int(10) UNSIGNED NOT NULL,
  `cqGeneE` int(10) UNSIGNED NOT NULL,
  `p_n_i` char(1) NOT NULL,
  `observacoes` varchar(300) DEFAULT NULL,
  `dataHoraInicio` datetime NOT NULL,
  `dataHoraFim` datetime NOT NULL,
  `resteste` tinyint(1) NOT NULL,
  `qnts_retestes` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estrutura da tabela `tb_tempopermanencia`
--

CREATE TABLE `tb_tempopermanencia` (
  `idTempoPermanencia` int(11) NOT NULL,
  `tempoPermanencia` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_tempopermanencia`
--

INSERT INTO `tb_tempopermanencia` (`idTempoPermanencia`, `tempoPermanencia`) VALUES
(1, 'temporária'),
(2, 'permanente'),
(4, 'tempo permanência b'),
(5, 'tempo permanência c'),
(6, 'tempo permanência d'),
(7, 'tempo 1');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_tipoamostra`
--

CREATE TABLE `tb_tipoamostra` (
  `idTipoAmostra` int(10) UNSIGNED NOT NULL,
  `tipo` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_tipoamostra`
--

INSERT INTO `tb_tipoamostra` (`idTipoAmostra`, `tipo`) VALUES
(5, 'congelada');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_tipolocal`
--

CREATE TABLE `tb_tipolocal` (
  `idTipoLocal` int(10) UNSIGNED NOT NULL,
  `nomeLocal` varchar(100) NOT NULL,
  `qntEspacosTotal` int(11) NOT NULL,
  `qntEspacosAmostra` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_tipolocal`
--

INSERT INTO `tb_tipolocal` (`idTipoLocal`, `nomeLocal`, `qntEspacosTotal`, `qntEspacosAmostra`) VALUES
(1, 'gaveta', 10, 0),
(10, 'freezer', 10, 10),
(11, 'gaveta 20', 10, 10),
(12, 'freezer a', 5, 5);
...
--
-- Estrutura da tabela `tb_tubo`
--

CREATE TABLE `tb_tubo` (
  `idTubo` int(10) UNSIGNED NOT NULL,
  `idTubo_fk` int(10) UNSIGNED DEFAULT NULL,
  `idAmostra_fk` int(10) UNSIGNED NOT NULL,
  `tuboOriginal` char(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_tubo`
--
...
ALTER TABLE `tb_amostra`
  ...
  ADD KEY `tb_amostra_FKIndex3` (`idPaciente_fk`),
  ADD KEY `tb_amostra_FKIndex2` (`cod_municipio_fk`),
  ADD KEY `tb_amostra_FKIndex1` (`cod_estado_fk`),
  ADD KEY `tb_amostra_FKIndex4` (`idNivelPrioridade_fk`),
  ADD KEY `tb_amostra_FKIndex5` (`idCodGAL_fk`),
...
ALTER TABLE `tb_cadastroamostra`
  ...
  ADD KEY `tb_cadastroAmostra_FKIndex1` (`idUsuario_fk`),
  ADD KEY `tb_cadastroAmostra_FKIndex2` (`idLocalArmazenamento_fk`),
...
ALTER TABLE `tb_equipamento`
  ...
  ADD KEY `fk_idDetentor` (`idDetentor_fk`),
  ADD KEY `fk_idMarca` (`idMarca_fk`),
...
ALTER TABLE `tb_etiqueta`
  ...
  ADD KEY `tb_etiqueta_FKIndex1` (`idAmostra_fk`),
  ADD KEY `tb_etiqueta_FKIndex2` (`idDoenca_fk`),
...
ALTER TABLE `tb_extracao`
  ...
  ADD KEY `tb_extracao_FKIndex1` (`idUsuario_fk`),
...
ALTER TABLE `tb_laudo`
  ...
  ADD KEY `tb_laudo_FKIndex1` (`idUsuario_fk`),
...
ALTER TABLE `tb_localarmazenamento`
  ...
  ADD KEY `tb_localArmazenamento_FKIndex2` (`idTipoLocal_fk`),
...
ALTER TABLE `tb_rel_amostra_tipo_local`
  ...
  ADD KEY `tb_rel_amostra_local_FKIndex1` (`tb_tipoAmostra_idTipoAmostra`),
  ADD KEY `tb_rel_amostra_local_FKIndex2` (`tb_amostra_idAmostra`),
...
ALTER TABLE `tb_rel_etiqueta_dataimpressao`
  ...
  ADD KEY `tb_rel_etiqueta_dataImpressao_FKIndex1` (`idEtiqueta_fk`),
...
ALTER TABLE `tb_rel_perfilusuario_recurso`
  ...
  ADD KEY `tb_rel_perfilUsuario_recurso_FKIndex1` (`idPerfilUsuario_fk`),
...
ALTER TABLE `tb_rel_usuario_perfilusuario`
  ...
  ADD KEY `tb_rel_usuario_perfilUsuario_FKIndex1` (`idUsuario_fk`),
...
ALTER TABLE `tb_rtpcr`
  ...
  ADD KEY `tb_RTPCR_FKIndex1` (`idEquipamento_fk`),
  ADD KEY `tb_RTPCR_FKIndex2` (`idAmostra_fk`),
...
--
ALTER TABLE `tb_amostra`
  MODIFY `idAmostra` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `tb_cadastroamostra`
--
ALTER TABLE `tb_cadastroamostra`
  MODIFY `idCadastroAmostra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tb_codgal`
  MODIFY `idCodGAL` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tb_infostubo`
  MODIFY `idInfosTubo` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tb_log`
  MODIFY `idLog` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
...
--
ALTER TABLE `tb_paciente`
  MODIFY `idPaciente` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
...
--
ALTER TABLE `tb_recurso`
  MODIFY `idRecurso` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;

--
-- AUTO_INCREMENT for table `tb_rel_perfilusuario_recurso`
--
ALTER TABLE `tb_rel_perfilusuario_recurso`
  MODIFY `id_rel_perfilUsuario_recurso` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;

--
-- AUTO_INCREMENT for table `tb_rel_usuario_perfilusuario`
--
ALTER TABLE `tb_rel_usuario_perfilusuario`
  MODIFY `id_rel_usuario_perfilUsuario` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
...
--
ALTER TABLE `tb_tubo`
  MODIFY `idTubo` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `tb_usuario`
--
ALTER TABLE `tb_usuario`
  MODIFY `idUsuario` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
...
--
-- Limitadores para a tabela `tab_municipio`
--
ALTER TABLE `tab_municipio`
  ADD CONSTRAINT `fk_tab_municipio_tab_estado` FOREIGN KEY (`cod_estado`) REFERENCES `tab_estado` (`cod_estado`);

--
-- Limitadores para a tabela `tb_amostra`
--
ALTER TABLE `tb_amostra`
  ADD CONSTRAINT `fk_idPerfilPaciente` FOREIGN KEY (`idPerfilPaciente_fk`) REFERENCES `tb_perfilpaciente` (`idPerfilPaciente`);

--
-- Limitadores para a tabela `tb_equipamento`
--
ALTER TABLE `tb_equipamento`
  ADD CONSTRAINT `fk_idDetentor` FOREIGN KEY (`idDetentor_fk`) REFERENCES `tb_detentor` (`idDetentor`),
  ADD CONSTRAINT `fk_idMarca` FOREIGN KEY (`idMarca_fk`) REFERENCES `tb_marca` (`idMarca`),
  ADD CONSTRAINT `fk_idModelo` FOREIGN KEY (`idModelo_fk`) REFERENCES `tb_modelo` (`idModelo`);

--
-- Limitadores para a tabela `tb_localarmazenamento`
--
ALTER TABLE `tb_localarmazenamento`
