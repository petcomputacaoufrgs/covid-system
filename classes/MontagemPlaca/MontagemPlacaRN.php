    ...
    public function alterar(MontagemPlaca $objMontagemPlaca) {
        ...
        try {
            ...
            if($objMontagemPlaca->getObjPocos() != null){
                ...
                $objRelTuboPlaca->setIdPlacaFk($objMontagemPlaca->getObjMix()->getIdPlacaFk());
                $arr = $objRelTuboPlacaRN->listar($objRelTuboPlaca);
                foreach ($arr as $rel) {
                    $objRelTuboPlacaRN->remover($rel);
                }
                ...
                if(is_array($objMontagemPlaca->getObjPocos())){
                    foreach ($objMontagemPlaca->getObjPocos() as $poco){
                        ...
                        //cadastrar os novos tubos
                        $objRelTuboPlaca->setIdTuboFk($objTubo->getIdTubo());
                        $objRelTuboPlaca->setIdPlacaFk($objMontagemPlaca->getObjMix()->getIdPlacaFK());
