    ...
    switch ($_GET['action']) {
        case 'cadastrar_amostra':
            ...
            if (isset($_GET['idPaciente'])) {
                ...
                if(count($arr_amostra_paciente) == 1) {$objAmostra = $arr_amostra_paciente[0];}
...
if (isset($_GET['idPaciente']) || $cadastrarNovo) {
    ...
    <?php if (!$sumir) { ?> 
                <div class="form-row">
                    <div class="col-md-6" >
                        <button class="btn btn-primary" style="width: 50%;margin-left:45%;" type="submit" name="salvar_cadastro"<?= $salvou ?>>Salvar</button>
                    </div>
