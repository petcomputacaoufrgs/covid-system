...
<form method="POST">
    <div class="form-row">
        <div class="col-md-5 mb-3">
         ...
         <div class="col-md-5 mb-3">
            <label for="label_tipoLocalArm">Digite nome do local de armazenamento</label>
            <input type="text" class="form-control" id="idNomeTipoLA" placeholder="tipo" 
                   onblur="validaNomeTipoLocalArmazenamento()" name="txtNomeTipoLocal"  value="'.$objTipoLocalArm->getCaractereTipo().'">
            <div id ="feedback_nomeLocal"></div>
