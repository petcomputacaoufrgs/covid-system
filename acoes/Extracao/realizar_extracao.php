  ...
  */
    ...
    switch ($_GET['action']) {
        case 'realizar_extracao':
            ...
            PreparoLoteINT::montar_select_lotes($select_grupos,$objPreparoLote, $objPreparoLoteRN, null,null);
        ...
        if (strlen($select_grupos) > 0) {
            ...
            if(isset($_GET['idTipoExtracao'] ) && $_GET['idTipoExtracao'] == Tipo::$TIPO_AUTOMATICO) {
                ...
                if (isset($_POST['btn_alocarCapela']) && !isset($_GET['idCapela'])) {
                    ...
                    $objPreparoLote->setIdPreparoLote(intval($_POST['sel_preparo_lote']));
                    PreparoLoteINT::montar_select_lotes($select_grupos,$objPreparoLote, $objPreparoLoteRN, null,null);
                    ...
                    $objPreparoLote->setIdCapelaFk(intval($_POST['sel_nivelSegsCapela']));

                    $objPreparoLote = $objPreparoLoteRN->consultar($objPreparoLote);

                    $objPreparoLote->setIdKitExtracaoFk(intval($_POST['sel_kit_extracao']));
                    $objKitExtracao->setIdKitExtracao(intval($_POST['sel_kit_extracao']));
                    KitExtracaoINT::montar_select_kitsExtracao($select_kitExtracao,$objKitExtracao, $objKitExtracaoRN, null,null);
                    ...
                    header('Location: ' . Sessao::getInstance()->assinar_link('controlador.php?action=realizar_extracao&idCapela=' . $_POST['sel_nivelSegsCapela'] . '&idPreparoLote=' . $_POST['sel_preparo_lote'] . '&idKitExtracao=' . $_POST['sel_kit_extracao']."&idTipoExtracao=".$_GET['idTipoExtracao']));
                    die();
...
if(!isset($_GET['idTipoExtracao']) && !isset($_GET['idPreparoLote'])){
    ...
    if ($_GET['action'] == 'realizar_extracao') {
        ...
        if($_GET['idTipoExtracao'] == Tipo::$TIPO_AUTOMATICO){ //|| isset($_GET['idPreparoLote'])) {
        ...
        if($_GET['idTipoExtracao'] == Tipo::$TIPO_MANUAL && !isset($_GET['idPreparoLote'])) {
            echo '<div class="col-md-6"> 
