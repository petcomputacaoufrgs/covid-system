    ...
    switch ($_GET['action']){
        case 'remover_montagemGrupo_extracao':
            try{
                ...
                header('Location: ' . Sessao::getInstance()->assinar_link('controlador.php?action=listar_preparo_inativacao'));
                die();
            }catch (Throwable $ex){
...
Pagina::montar_topo_listar('LISTAR GRUPOS DE EXTRAÇÃO', null, null, 'realizar_extracao', 'NOVA EXTRAÇÃO');
