...
try{
    ...
    //$objEquipamento->setNomeEquipamento("CARINE");
    //ProtocoloINT::tabelaAzul_protocolo_agpath_charite($tabela_protocolo, $objEquipamento);
    //$arrPrimeiraColuna = array(9.4,5,1,15,5,20,1);
    //$numAmostras = 19;
    //ProtocoloINT::tabela_Controle_protocolo_newgene($tabela_protocolo,19,$arrPrimeiraColuna);
