...
<?php Pagina::getInstance()->fechar_head(); 
          ...
          <div class="row">
              ...
              <?php
                    if(Sessao::getInstance()->verificar_permissao('cadastrar_amostra') ||
                        ...
                        || Sessao::getInstance()->verificar_permissao('gerar_estatisticas_relatorios')) {
            ...
            ?>
              ...
              */
              ...
              <?php
              // echo '<div class="col-md-1><h4>AMOSTRA</h4></div>';
              if(Sessao::getInstance()->verificar_permissao('gerar_estatisticas_relatorios')){
                  echo '<div class="col-md-3">
                          <a target="_blank" class="btn btn-primary"  STYLE="margin-top: 17px;background-color: #164599;" href="'.Sessao::getInstance()->assinar_link('controlador.php?action=gerar_estatisticas_relatorios').'">ESTATÍSTICAS </a>'
                      . '</div>';
              }
              ?>
    ...
    <div class="conjunto_itens" STYLE="margin-top: 10px;">
        <div class="row">
            ...
            <?php
            if(Sessao::getInstance()->verificar_permissao('cadastrar_reteste')) {
                echo '<div class="col-md-2">
                                <h5> Etapa RETESTE </h5>
                              </div>';
            }
            ...
            if (Sessao::getInstance()->verificar_permissao('cadastrar_reteste') || Sessao::getInstance()->verificar_permissao('listar_reteste')) {
                echo '<div class="col-md-3">
                              <a class="btn btn-primary" href="' . Sessao::getInstance()->assinar_link('controlador.php?action=cadastrar_reteste') . '">CADASTRO RETESTE </a>'
                    . '</div>';
            }
            ...
            if (Sessao::getInstance()->verificar_permissao('listar_reteste')) {
                echo '<div class="col-md-3">
                              <a class="btn btn-primary" href="' . Sessao::getInstance()->assinar_link('controlador.php?action=listar_reteste') . '">LISTAR RETESTE </a>'
                    . '</div>';
            }
